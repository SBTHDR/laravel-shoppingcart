...
namespace Sparrowow\Tests\Shoppingcart;

use Mockery;
use PHPUnit\Framework\Assert;
use Sparrowow\Shoppingcart\Cart;
use Orchestra\Testbench\TestCase;
use Illuminate\Auth\Events\Logout;
use Illuminate\Support\Collection;
use Sparrowow\Shoppingcart\CartItem;
use Illuminate\Support\Facades\Event;
use Illuminate\Session\SessionManager;
use Illuminate\Contracts\Auth\Authenticatable;
use Sparrowow\Shoppingcart\ShoppingcartServiceProvider;
use Sparrowow\Tests\Shoppingcart\Fixtures\ProductModel;
use Sparrowow\Tests\Shoppingcart\Fixtures\BuyableProduct;
...
class CartTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \Sparrowow\Shoppingcart\Exceptions\InvalidRowIDException
     */
    ...
    /**
     * @test
     * @expectedException \Sparrowow\Shoppingcart\Exceptions\UnknownModelException
    ...
    /**
     * @test
     * @expectedException \Sparrowow\Shoppingcart\Exceptions\CartAlreadyStoredException
